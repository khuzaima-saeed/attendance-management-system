...
//             <strong>User ID: {attendance.employeeId}</strong> - 
//             Date: {attendance.date} - 
//             Time In: {attendance.timeIn} - 
//             Time Out: {attendance.timeOut ? attendance.timeOut : 'Not checked out'}
//             {attendance.timeOut && calculateDuration(attendance.timeIn, attendance.timeOut)}
//           </li>
//         ))}
//       </ul>
//     </div>
...
//     //   return 'Unknown';
//     // }
//     console.log(employeeNames.firstName)
//   };
...
//         {attendances.map(attendance => (
//           <li key={attendance.id}>
//             <strong>Name: </strong>  {attendance.employeeName}- 
//             <br />
//             <strong>Date:</strong> {attendance.date} - 
//             <br />
//             <strong>Time In:</strong> {attendance.timeIn} - 
//             <br />
//             <strong>Time Out:</strong> {attendance.timeOut ? attendance.timeOut : 'Not checked out'}
//             <br />
//             <strong>Duration:</strong> {attendance.timeOut && calculateDuration(attendance.timeIn, attendance.timeOut)}
//           </li>
//         ))}
//       </ul>
//     </div>
...
const AdminPage = () => {
  ...
  return (
    ...
    //     <p>No Attendances Marked Today</p>
    //   ) : (
    //     <ul>
    //     {attendances.map(attendance => (
    //       <li key={attendance.id}>
    ...
    // <div className=" mx-auto mt-8 text-gray-100 bg-slate-900 h-screen">
    ...
    //             <th className="px-4 py-2 bg-gray-800">Date</th>
    //             <th className="px-4 py-2 bg-gray-800">Time In</th>
    //             <th className="px-4 py-2 bg-gray-800">Time Out</th>
    //             <th className="px-4 py-2 bg-gray-800">Duration</th>
    //           </tr>
    //         </thead>
    //         <tbody>
    //           {attendances.map(attendance => (
    ...
    //               <td className="border px-4 py-2">{attendance.timeOut ? attendance.timeOut : 'Not checked out'}</td>
    //               <td className="border px-4 py-2">{attendance.timeOut ? calculateDuration(attendance.timeIn, attendance.timeOut) : '-'}</td>
    //             </tr>
    //           ))}
    //         </tbody>
    //       </table>
